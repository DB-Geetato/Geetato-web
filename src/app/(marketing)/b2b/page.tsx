            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
              <div className="order-2 lg:order-1">
                ...
                <div className="order-1 lg:order-2 relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
                  <Image
                    src="https://images.unsplash.com/photo-1595122245953-d183f08f883b?q=80&w=2070&auto=format&fit=crop"
                    alt="Daily fresh bread supply for restaurants and cafes - Geetato Artisan Bakery"
                    fill
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
                  <Image
                    src="https://images.unsplash.com/photo-1549462184-b09ad0a4af67?q=80&w=2070&auto=format&fit=crop"
                    alt="Premium corporate gift hampers and bakery treat boxes for employee appreciation"
                    fill
                    sizes="(max-width: 1024px) 100vw, 50vw"
                    className="object-cover"
                  />
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
                ...
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
                  <Image
                    ...
                    alt="Specialized bread supply for cloud kitchens and fast food establishments - Burger buns and bases"
                    fill
                    sizes="(max-width: 1024px) 100vw, 50vw"
                    className="object-cover"
                  />

            ...
            <div className="flex flex-col gap-8 text-center lg:text-left">
              <div className="inline-flex items-center self-center lg:self-start rounded-full bg-geetato-pink/10 px-4 py-1.5 text-sm font-semibold text-geetato-pink">
                ...
                <h1 className="text-4xl font-bold tracking-tight text-geetato-charcoal sm:text-6xl">
                  Premium Artisan Breads & Export-Grade Snacks: <br />
                  <span className="text-geetato-pink">Crafted for Corporate & Bulk Supply.</span>
                </h1>
                <p className="text-lg leading-8 text-muted-foreground">
                  Freshly baked daily in Ghaziabad. Zero preservatives. Trusted by 50+ Corporate Partners.
                </p>
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
                  <Link
                    href="https://wa.me/919266093334?text=Hi%20Geetato,%20I%20am%20interested%20in%20partnering%20for%20daily%20supply..."
                  ...
                  >
                    Partner for Daily Supply
                    <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                  </Link>
                  <Link
                    href="https://www.zomato.com/ncr/geetato-bakes-bliss-indirapuram-ghaziabad/order"
                    target="_blank"
                  ...
                  <div className="relative aspect-square overflow-hidden rounded-[2.5rem] shadow-2xl">
                    <Image
                      ...
                      alt="Artisan Breads - Premium bakery supply by Geetato"
                      fill
              ...
              {[
                {
                  ...
                  desc: "Sourdough, Multigrain & Burger Buns for Cafes/HORECA",
                  icon: "🥖",
                  href: "/products#breads",
                },
                {
                  title: "Export Solutions",
                  desc: "Makhana, Cookies & Shelf-stable healthy snacks",
                  icon: "🌍",
                  href: "/products#snacks",
                },
                {
                  title: "Corporate Gifting",
                  desc: "Festive boxes & Geetato branded hampers",
                  icon: "🎁",
                  href: "/b2b",
                },
                {
                  title: "Custom Celebrations",
                  desc: "Bespoke Cakes & Pastries for your moments",
                  icon: "🎂",
                  href: "/products#cakes",
                },
              ].map((cat, i) => (
